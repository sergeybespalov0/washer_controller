...
/**
 * screen, used to enter numeric passwords,
 * difference between this screen and numeric enter is
 * that entering text is not showed
 */
public class PasswordEnterScreen implements IDataTransfer, InputProcessor {
    ...
    private boolean _incorrect_weight = false;

    private String _content;
    private String _content_to_view;
     ...
     */
    public PasswordEnterScreen(Main main, SpriteBatch batch, ShapeRenderer renderer, OrthographicCamera camera
    ) {
    ...
    public void Initialize(IDataTransfer lastScreen, String textToEnter,
        ...
        if (lastScreen == null || textToEnter.isEmpty()) {
            throw new NullPointerException("EnterPortScreen pre-use initialization parameters can't be null");
        }
        _minimum = minimum;
        _maximum = maximum;
    ...
    private void initializeButtons() {
        ...
        float _textBox_weight_y = Main.SCREEN_HEIGHT - Main.SCREEN_HEIGHT / 8 / 2 -
                (Main.SCREEN_HEIGHT / 8 + Main.SCREEN_HEIGHT / 8 / 5);
 ...
 */
    ...
    private void updateBeforeDraw() {
        ...
        _textBox_content.updateContent(_content_to_view);
    ...
    private void draw() {
        ...
        drawIncorrectDataIndicator(_incorrect_weight, _batch);
    ...
    private boolean checkContent() {
        return !_content.equals("") && (Integer.parseInt(_content) < _maximum) && (Integer.parseInt(_content) > _minimum);
    }
    ...
    public void show() {
        dePressButtons();
        _main._status.updateNavigation(TextValues.navigation.passwordEnterScreen);
        _timer = 0;
