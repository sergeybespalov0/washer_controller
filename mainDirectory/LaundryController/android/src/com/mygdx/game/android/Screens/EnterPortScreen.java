...
/**
 * screen, used to enter port
 */
public class EnterPortScreen implements IDataTransfer, InputProcessor {
     ...
     */
    public EnterPortScreen(Main main, SpriteBatch batch, ShapeRenderer renderer, OrthographicCamera camera
    ) {
    ...
    public void Initialize(IDataTransfer lastScreen) {
        ...
        _textToEnter = TextValues.globalValues.port;
        _textToEnter_glyphLayout.setText(_textToEnter_font, _textToEnter);
    }
 ...
 */
    ...
    public void show() {
        dePressButtons();
        _main._status.updateNavigation(TextValues.navigation.enterPortScreen);
        _timer = 0;
